...
pub const fn get_default_keymap() -> [[[KeyAction; COL]; ROW]; NUM_LAYER] {
    [
        ...
        [
            ...
            [shifted!(Kc5), k!(KpSlash), k!(KpAsterisk), k!(KpMinus), k!(KpPlus), a!(Transparent), shifted!(Kc6), a!(Transparent), a!(Transparent), k!(Equal), shifted!(Semicolon)],
        ...
        [
            ...
            [wm!(T, GUI_SHIFT), shifted!(Backslash), shifted!(Kc7), shifted!(Kc1), shifted!(Kc6), a!(Transparent), shifted!(Kc4), k!(Right), k!(Up), k!(Down), k!(Left)],
            [a!(Transparent), shifted!(Kc3), k!(Grave), shifted!(Grave), wm!(S, GUI_SHIFT), user!(5), k!(Backslash), a!(Transparent), shifted!(Kc2), k!(Equal), a!(Transparent)],
...
pub const fn get_default_encoder_map() -> [[EncoderAction; NUM_ENCODER]; NUM_LAYER] {
    [
        ...
        [encoder!(k!(MouseWheelUp), k!(MouseWheelDown))],
        [encoder!(k!(MouseWheelRight), k!(MouseWheelLeft))],
